namespace NetCoreAi.Project3._1_RapidApi.ViewModels
{
    public class ApieriesResponse
    {
        public string page { get; set; }
        public List<ApieriesViewModels> result { get; set; }
    }

    public class ApieriesViewModels
    {
